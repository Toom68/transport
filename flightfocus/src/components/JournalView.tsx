  ...
  if (entries.length === 0) {
    return (
      <div className="text-center py-8 px-4">
        ...
        <p className="text-[10px] text-theme-muted mt-1">Complete a leg to write your first page.</p>
      </div>
    );
  }
              ...
              <div className="flex items-center gap-2.5 px-3 py-2.5">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-1 mt-0.5">
                    ...
                    <span className="text-[10px] text-theme-secondary truncate">{entry.fromPlace.city}</span>
                  </div>
                </div>
